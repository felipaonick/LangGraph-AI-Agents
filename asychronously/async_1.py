"""
Ora vogliamo convertire il semplice grafo di async aggiungendo un nodo B2
Come prima si parte con l'esecuzione del nodo A poi si va ad eseguire in parallelo
i nodi B e C. Dopo che il nodo B ha terminato si va ad eseguire il nuovo nodo B2.
E solo dopo che si è eseguito anche il nodo B2 allora andiamo ad eseguire il nodo D.
"""
...
graph.get_graph().draw_mermaid_png(output_file_path="async_1.png")

if __name__ == "__main__":
    print("HI Async graph")
